...
describe('Sidebar 信息架构（AC12/V8）', () => {
  ...
  it('Phase 2 项可见但禁用（phase2 M2 后：书签/剪藏/快照已点亮，剩余 6 项）', () => {
    renderSidebar()
    const planned = [
      'API 来源', '邮件简报', 'Obsidian 库',
